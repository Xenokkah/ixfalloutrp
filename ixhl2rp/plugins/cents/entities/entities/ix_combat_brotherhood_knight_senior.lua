...
ENT.PrintName = "Brotherhood Senior Knight"
ENT.Category = "Helix - Combat Entities - Brotherhood of Steel"
ENT.Spawnable = true
ENT.AdminOnly = true

ENT.name = "Brotherhood Senior Knight"
ENT.description = "A Brotherhood Senior Knight, skills honed to a sharp edge."
...
local weapons = {
    ...
    "models/halokiller38/fallout/weapons/energy weapons/bm_laserpdw.mdl",
