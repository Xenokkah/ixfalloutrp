...
function PLUGIN:HUDPaint()
	local hunger = Material("icon16/lightning.png", "noclamp smooth") 
	local thirst = Material("icon16/drink.png", "noclamp smooth") 
