ITEM.name = "Nuka Cola Frost"
ITEM.model = "models/maxib123/nukafrost.mdl"
ITEM.thirst = 35
ITEM.description = "A bottle of Nuka Cola's winter signature."
ITEM.longdesc = "A warm, sealed bottle of Nuka Cola Frost, sold only during the Christmas months. Has a faint hint of mint and strawberries."
ITEM.quantity = 1
ITEM.price = 5
ITEM.width = 1
ITEM.height = 2
