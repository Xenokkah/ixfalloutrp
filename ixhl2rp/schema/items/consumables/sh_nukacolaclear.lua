ITEM.name = "Nuka Cola Clear"
ITEM.model = "models/maxib123/nukaclear.mdl"
ITEM.thirst = 20
ITEM.description = "A bottle of Nuka Cola's lemonade drink."
ITEM.longdesc = "A warm, sealed bottle of Nuka Cola Clear, a lemon-lime flavored drink that was in extremely limited production before the war, but several batches were produced in the Mojave factory."
ITEM.quantity = 1
ITEM.price = 5
ITEM.width = 1
ITEM.height = 2
