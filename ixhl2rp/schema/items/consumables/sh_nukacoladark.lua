...
ITEM.thirst = 20
ITEM.description = "A bottle of Nuka Cola's flagship alcohol drink."
ITEM.longdesc = "A warm, sealed bottle of Nuka Cola Dark, the brand's most common mixed drink. An overall light acoholic drink, the name itself comes from the dark coloration of the mixture."
ITEM.quantity = 1
ITEM.price = 5
ITEM.width = 1
ITEM.height = 2
