ITEM.name = "Nuka Cola Fusion Cold"
ITEM.model = "models/maxib123/nukafusion.mdl"
ITEM.thirst = 35
ITEM.description = "A bottle of Nuka Cola's most fruity drink, chilled to perfection."
ITEM.longdesc = "A warm, sealed bottle of Nuka Cola Fusion, a carbonated drink with elements of apples, oranges, and lime. Surprisingly unpopular, but is very refreshing when cold."
ITEM.quantity = 1
ITEM.price = 5
ITEM.width = 1
ITEM.height = 2
