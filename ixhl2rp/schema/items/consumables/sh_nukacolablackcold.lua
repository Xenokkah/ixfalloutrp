...
ITEM.thirst = 30
ITEM.description = "A bottle of Nuka Cola's strongest alcohol, chilled to perfection."
ITEM.longdesc = "A cold, sealed bottle of Nuka Cola Black, which consists of hard liquor and cola. Appreciated by alcohol officianados, it is a bit of a niche drink. When cold, it is often served with a meal."
ITEM.quantity = 1
ITEM.price = 5
ITEM.width = 1
ITEM.height = 2
