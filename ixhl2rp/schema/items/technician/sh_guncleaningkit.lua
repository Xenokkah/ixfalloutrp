...
ITEM.description = "A cleaning kit for weapons."
ITEM.longdesc = "A kit full of oils, cloths, brushes, and more for cleaning up accumulated gunpowder, residue, and even rust. As long as the parts work, this kit will make it squeaky clean with a little time and elbow grease."
ITEM.category = "Weapon Repair"
ITEM.repairAmount = 15
ITEM.height = 1
ITEM.width = 2
ITEM.repairTreshhold = 60
ITEM.maxStack = 3
ITEM.flag = "A"
