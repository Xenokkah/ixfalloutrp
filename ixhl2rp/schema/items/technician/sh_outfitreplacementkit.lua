ITEM.name = "Outfit Repair and Replacement Kit"
ITEM.model = "models/mosi/fallout4/props/junk/modcrate.mdl"
ITEM.description = "A set of replacement parts and plates for restoring heavily damaged suits."
ITEM.longdesc = "A box full of parts for armor, good for repairing heavily damaged suit with outright broken components."
ITEM.flag = "3"
