ITEM.name = "Emergency Armor Patch Kit"
ITEM.model = "models/mosi/fallout4/props/junk/modcrate.mdl"
ITEM.description = "A set of adhesive patches to quickly fix damaged wearables."
ITEM.longdesc = "When it comes to repairing minor damage from scuffles in battle, quick-fixes like these will do the trick in most cases without being too expensive to buy or make."
ITEM.flag = "3"
