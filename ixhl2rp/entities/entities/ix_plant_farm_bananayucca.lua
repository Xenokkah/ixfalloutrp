...
ENT.Type             = "anim"
ENT.PrintName        = "Domestic Banana Yucca"
ENT.Author            = "Scrat"
    ...
    if (activator:IsPlayer()) then
        ...
        if (bHarvestable == true) then
            ...
            if Fertilized == true then
                target:GetInventory():Add("yucca", 4)
            else
                target:GetInventory():Add("yucca", 2)
            end 
            ...
            if (seedchance >= 65) then target:GetInventory():Add("seedyucca", 1) end
