...
ENT.Type             = "anim"
ENT.PrintName        = "Domestic Honey Mesquite Pod"
ENT.Author            = "Scrat"
...
if (SERVER) then
    function ENT:Initialize()
        self:SetModel("models/mosi/fnv/props/plants/honeymesquite.mdl")
    ...
    if (activator:IsPlayer()) then
        ...
        if (bHarvestable == true) then
            ...
            if Fertilized == true then
                target:GetInventory():Add("honeymesquitepod", 4)
            else
            ...
            if (seedchance >= 65) then target:GetInventory():Add("seedhoneymesquite", 1) end
