...
ENT.Type             = "anim"
ENT.PrintName        = "Domestic White Horsenettle"
ENT.Author            = "Scrat"
...
if (SERVER) then
    function ENT:Initialize()
        self:SetModel("models/mosi/fnv/props/plants/whitehorsenettle.mdl")
    ...
    if (activator:IsPlayer()) then
        ...
        if (bHarvestable == true) then
            ...
            if Fertilized == true then
                target:GetInventory():Add("whitehorsenettle", 4)
            else
                target:GetInventory():Add("whitehorsenettle", 2)
            end 
            ...
            if (seedchance >= 65) then target:GetInventory():Add("seedwhitehorsenettle", 1) end
