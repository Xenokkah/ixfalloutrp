...
ENT.Type             = "anim"
ENT.PrintName        = "Domestic Xander Root"
ENT.Author            = "Scrat"
    ...
    if (activator:IsPlayer()) then
        ...
        if (bHarvestable == true) then
            ...
            if Fertilized == true then
                target:GetInventory():Add("xanderroot", 4)
            else
                target:GetInventory():Add("xanderroot", 2)
            end 
            ...
            if (seedchance >= 65) then target:GetInventory():Add("seedxanderroot", 1) end
