...
ENT.Type             = "anim"
ENT.PrintName        = "Domestic Broc Flower"
ENT.Author            = "Scrat"
...
if (SERVER) then
    function ENT:Initialize()
        self:SetModel("models/mosi/fnv/props/plants/brocflower.mdl")
    ...
    if (activator:IsPlayer()) then
        ...
        if (bHarvestable == true) then
            ...
            if Fertilized == true then
                target:GetInventory():Add("brocflower", 4)
            else
                target:GetInventory():Add("brocflower", 2)
            end 
            ...
            if (seedchance >= 65) then target:GetInventory():Add("seedbrocflower", 1) end
