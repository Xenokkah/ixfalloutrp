...
ENT.Type             = "anim"
ENT.PrintName        = "Domestic Prickly Pear Fruit"
ENT.Author            = "Scrat"
    ...
    if (activator:IsPlayer()) then
        ...
        if (bHarvestable == true) then
            ...
            if Fertilized == true then
                target:GetInventory():Add("pricklypear", 4)
            else
                target:GetInventory():Add("pricklypear", 2)
            end 
            ...
            if (seedchance >= 65) then target:GetInventory():Add("seedpricklypear", 1) end
