...
ENT.Type             = "anim"
ENT.PrintName        = "Domestic Pinto Beans"
ENT.Author            = "Scrat"
    ...
    if (activator:IsPlayer()) then
        ...
        if (bHarvestable == true) then
            ...
            if Fertilized == true then
                target:GetInventory():Add("pintobeans", 4)
            else
                target:GetInventory():Add("pintobeans", 2)
            end 
            ...
            if (seedchance >= 65) then target:GetInventory():Add("seedpintobeans", 1) end
