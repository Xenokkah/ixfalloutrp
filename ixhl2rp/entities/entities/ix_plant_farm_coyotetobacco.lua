...
ENT.Type             = "anim"
ENT.PrintName        = "Domestic Coyote Tobacco"
ENT.Author            = "Scrat"
    ...
    if (activator:IsPlayer()) then
        ...
        if (bHarvestable == true) then
            ...
            if Fertilized == true then
                target:GetInventory():Add("coyotetobaccochew", 4)
            else
                target:GetInventory():Add("coyotetobaccochew", 2)
            end 
            ...
            if (seedchance >= 65) then target:GetInventory():Add("seedcoyotetobacco", 1) end
