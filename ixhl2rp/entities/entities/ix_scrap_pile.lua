...
if (SERVER) then
    function ENT:Initialize()
        self:SetModel("models/fallout_nv/architecture/megaton_sized/debris/groundlitterpile01.mdl")
...
function ENT:Use(activator)
    if (activator:IsPlayer()) then
        ...
        activator:NewVegasNotify("You salvage some bits of scrap from the pile.", "messageNeutral", 3)
