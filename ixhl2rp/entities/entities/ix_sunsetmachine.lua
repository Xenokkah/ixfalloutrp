...
ENT.Type             = "anim"
ENT.PrintName        = "Sunset Sarsaparilla Vending Machine"
ENT.Author            = "Scrat"
...
function ENT:Use(activator)
    if (activator:IsPlayer()) then
        ...
        if (target:GetInventory():HasItem("prewarmoney")) then
            ...
            target:GetInventory():Add("sunsetsarsaparilla", 1)
...
if (CLIENT) then
    function ENT:OnPopulateEntityInfo(tooltip)
        ...
        descriptionfull:SetText("A semi-functional Sunset Sarsaparilla machine with bottles still inside, ready to dispense the classic root beer of the west, though warm. Uses pre-war money." )
